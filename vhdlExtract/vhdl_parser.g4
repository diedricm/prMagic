...
parser grammar vhdl_parser;

//------------------------------------------Parser----------------------------------------

options { tokenVocab=vhdl_lexer; }
...
component_instantiation_statement
  : reconflist label_colon instantiated_unit
  ( generic_map_aspect )?
...
module_reconf_entry: PRCOMMENT LPAREN identifier RPAREN SEMI;
